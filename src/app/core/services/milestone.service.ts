...
export class MilestoneService extends BaseService {
  ...
  getMilestonesByProjectId(projectId: string): Observable<MilestoneDTO[]> {
    return this.get<MilestoneDTO[]>(`projects/${projectId}/milestones`);
  }
}
