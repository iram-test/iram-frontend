...
export class SubsectionService extends BaseService {
  ...
  createSubsection(
    subsection: CreateSubsectionDTO,
    sectionId: string,
  ): Observable<SubsectionDTO> {
    return this.post<SubsectionDTO>(
  ...
  updateSubsection(
    id: string,
    subsection: UpdateSubsectionDTO,
  ): Observable<SubsectionDTO> {
  ...
  getSubsectionsBySectionId(sectionId: string): Observable<SubsectionDTO[]> {
    return this.get<SubsectionDTO[]>(`sections/${sectionId}/subsections`);
  }
}