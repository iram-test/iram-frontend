...
import { TestReportDTO, CreateTestReportDTO, UpdateTestReportDTO } from '../models/test-report-dto';
...
export class TestReportService extends BaseService {
  ...
  createTestReport(testReport: CreateTestReportDTO, projectId: string): Observable<TestReportDTO> {
    return this.post<TestReportDTO>(`projects/${projectId}/test-reports`, testReport);
  }

  updateTestReport(id: string, testReport: UpdateTestReportDTO): Observable<TestReportDTO> {
